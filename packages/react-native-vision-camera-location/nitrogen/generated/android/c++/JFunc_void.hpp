...
namespace margelo::nitro::camera::location {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/camera/location/Func_void;";
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/camera/location/Func_void_cxx;";
