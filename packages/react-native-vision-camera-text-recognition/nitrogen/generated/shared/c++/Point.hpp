...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::camera::textrecognition::Point> final {
    static inline margelo::nitro::camera::textrecognition::Point fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::camera::textrecognition::Point(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::camera::textrecognition::Point& arg) {
