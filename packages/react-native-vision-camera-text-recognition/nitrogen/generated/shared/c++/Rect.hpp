...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::camera::textrecognition::Rect> final {
    static inline margelo::nitro::camera::textrecognition::Rect fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::camera::textrecognition::Rect(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::camera::textrecognition::Rect& arg) {
