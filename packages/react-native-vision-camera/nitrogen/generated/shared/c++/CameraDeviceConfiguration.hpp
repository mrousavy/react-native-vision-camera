...
namespace margelo::nitro::camera {
  ...
  /**
   * A struct which can be represented as a JavaScript object (CameraDeviceConfiguration).
   */
  struct CameraDeviceConfiguration {
  public:
...
namespace margelo::nitro {
  ...
  // C++ CameraDeviceConfiguration <> JS CameraDeviceConfiguration (object)
  template <>
  struct JSIConverter<margelo::nitro::camera::CameraDeviceConfiguration> final {
    static inline margelo::nitro::camera::CameraDeviceConfiguration fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::camera::CameraDeviceConfiguration(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::camera::CameraDeviceConfiguration& arg) {
