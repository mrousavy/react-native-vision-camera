...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::camera::Size> final {
    static inline margelo::nitro::camera::Size fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::camera::Size(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::camera::Size& arg) {
