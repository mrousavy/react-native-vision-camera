...
open class HybridCameraFrameOutputSpec_cxx : HybridCameraOutputSpec_cxx {
   ...
   */
  private var __cxxPart: bridge.std__weak_ptr_HybridCameraFrameOutputSpec_
   ...
   * The C++ part is a `std::shared_ptr<HybridCameraFrameOutputSpec>`.
   */
  public func getCxxPart() -> bridge.std__shared_ptr_HybridCameraFrameOutputSpec_ {
    let cachedCxxPart = self.__cxxPart.lock()
    if Bool(fromCxx: cachedCxxPart) {
      return cachedCxxPart
    } else {
      let newCxxPart = bridge.create_std__shared_ptr_HybridCameraFrameOutputSpec_(self.toUnsafe())
      __cxxPart = bridge.weakify_std__shared_ptr_HybridCameraFrameOutputSpec_(newCxxPart)
      return newCxxPart
    }
  }

  public override func getCxxPart() -> bridge.std__shared_ptr_HybridCameraOutputSpec_ {
    let ownCxxPart: bridge.std__shared_ptr_HybridCameraFrameOutputSpec_ = getCxxPart()
