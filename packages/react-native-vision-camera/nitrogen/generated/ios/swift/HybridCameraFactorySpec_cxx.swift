...
open class HybridCameraFactorySpec_cxx {
  ...
  @inline(__always)
  public final func createFrameOutput() -> bridge.Result_std__shared_ptr_HybridCameraSessionFrameOutputSpec__ {
    do {
      let __result = try self.__implementation.createFrameOutput()
