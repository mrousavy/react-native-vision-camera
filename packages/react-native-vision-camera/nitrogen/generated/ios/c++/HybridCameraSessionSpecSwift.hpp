...
namespace margelo::nitro::camera {
  ...
  public:
    // Methods
    inline std::shared_ptr<Promise<void>> configureOutputs(const std::shared_ptr<HybridCameraSessionOutputSpec>& outputs) override {
      auto __result = _swiftPart.configureOutputs(outputs);
