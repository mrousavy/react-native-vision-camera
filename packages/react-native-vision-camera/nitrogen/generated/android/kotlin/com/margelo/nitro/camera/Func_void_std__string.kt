...
/**
 * Represents the JavaScript callback `(filePath: string) => void`.
...
fun interface Func_void_std__string: (String) -> Unit {
  ...
  @DoNotStrip
  @Keep
  override fun invoke(filePath: String): Unit
}
...
class Func_void_std__string_cxx: Func_void_std__string {
  ...
  @FastNative
  private external fun invoke_cxx(filePath: String): Unit
}
