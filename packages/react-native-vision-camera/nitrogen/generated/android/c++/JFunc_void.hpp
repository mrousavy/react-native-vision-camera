...
namespace margelo::nitro::camera {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/camera/Func_void;";
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/camera/Func_void_cxx;";
