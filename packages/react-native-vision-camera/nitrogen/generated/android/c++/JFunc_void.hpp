...
namespace margelo::nitro::camera {
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/camera/Func_void;";
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/camera/Func_void_cxx;";
