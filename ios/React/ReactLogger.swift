...
enum ReactLogger {
  static func log(level: RCTLogLevel, message: String, alsoLogToJS: Bool = false, _ file: String = #file, _ lineNumber: Int = #line, _ function: String = #function) {
  ...
  static func logJS(level: RCTLogLevel, message: String, _ file: String = #file, _ lineNumber: Int = #line, _ function: String = #function) {
