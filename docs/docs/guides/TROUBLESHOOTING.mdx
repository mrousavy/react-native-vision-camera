...
1. Try cleaning and rebuilding **everything**:
   ...
   npm i  # or "yarn"
   ```
2. Make sure you have installed the [Android NDK](https://developer.android.com/ndk).
3. Make sure your minimum SDK version is **21 or higher**, and target SDK version is **33 or higher**. See [the example's `build.gradle`](https://github.com/mrousavy/react-native-vision-camera/blob/main/example/android/build.gradle#L5-L10) for reference.
