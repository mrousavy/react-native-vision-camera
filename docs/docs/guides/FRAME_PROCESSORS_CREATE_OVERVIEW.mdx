...
| `ArrayBuffer`        | [`TypedArray`][7]             | [`TypedArray`][8]          |
...
[7]: https://github.com/mrousavy/react-native-vision-camera/blob/main/package/ios/Frame%20Processor/TypedArray.h
[8]: https://github.com/mrousavy/react-native-vision-camera/blob/main/package/android/src/main/java/com/mrousavy/camera/frameprocessor/TypedArray.java
