...
If you use [ProGuard](https://reactnative.dev/docs/next/signed-apk-android#enabling-proguard-to-reduce-the-size-of-the-apk-optional), make sure to add this to your `proguard-rules.pro` file:
