...
* [nonam4/**react-native-vision-camera-face-detector**](https://github.com/nonam4/react-native-vision-camera-face-detector): A V4 frame processor plugin to detect faces using MLKit Vision Face Detector. Can be combined with [Skia Frame Processor](https://github.com/mrousavy/FaceBlurApp).
