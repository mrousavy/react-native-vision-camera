...
* [gev2002/**react-native-vision-camera-image-labeling-v3
**](https://github.com/gev2002/react-native-vision-camera-image-labeling-v3): Frame processor plugin to image labeling using Google ML Kit library for react-native-vision-camera with high performance.
