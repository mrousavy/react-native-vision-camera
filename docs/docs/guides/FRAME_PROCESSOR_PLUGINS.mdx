...
* [gev2002/**react-native-vision-camera-face-detector-v3*](https://github.com/gev2002/react-native-vision-camera-face-detector-v3): Frame processor plugin to detect faces using Google ML Kit library for react-native-vision-camera with high performance and many options.
