...
<div>
<<<<<<< HEAD:docs/docs/guides/FORMATS.mdx
<<<<<<< HEAD:docs/docs/guides/FORMATS.mdx
  <img align="right" width="283" src={useBaseUrl("img/example.png")} />
=======
  <img align="right" width="35%" src={useBaseUrl("img/example.png")} />
>>>>>>> Merge branch 'main' into frame-processors:docs/docs/FORMATS.mdx
=======
  <img align="right" width="283" src={useBaseUrl("img/example.png")} />
>>>>>>> Docs: use static width for images (283):docs/docs/FORMATS.mdx
</div>
