...
<div className="image-container">
  <img width="283" src="/img/example_intro.png" />
</div>

<Tabs items={['Expo', 'React Native']} groupId="platform" persist>
<Tab value="Expo">

## Installing the library

Install [react-native-vision-camera](https://www.npmjs.com/package/react-native-vision-camera) through your preferred package manager:
...
```bash
pnpm dlx expo install react-native-vision-camera
```
...
```bash
bunx expo install react-native-vision-camera
```

</Tab>
</Tabs>

VisionCamera requires **iOS 12 or higher**, and **Android-SDK version 21 or higher**. See [Troubleshooting](/docs/troubleshooting) if you're having installation issues.
...
If your app has permission to use the Camera and Microphone, simply use the [`useCameraDevice(...)`](/docs/api#usecameradevice) hook to get a Camera device (see [Camera Devices](/docs/devices)) and mount the `<Camera>` view:
