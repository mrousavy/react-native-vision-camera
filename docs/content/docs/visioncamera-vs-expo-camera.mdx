...
| [Configurable `focusTo(...)`](tap-to-focus) | ✅ | ❌ |
...
| [Maximum Photo Resolution](camera-outputs) | ✅ | ❌ |
...
| [Specific Camera/Lens Selection](devices) | ✅ | Front/back + iOS lenses |
...
| [Custom Photo JPEG Quality](photo-quality) | ✅ | ✅ |
| [Photo `qualityPrioritization`](photo-quality) | ✅ | ❌ |
