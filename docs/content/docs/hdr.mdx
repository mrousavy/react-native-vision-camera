...
| ------------------------------------- | ------------------------------------- |
| ![SDR Photo](/img/sdr_comparison.png) | ![HDR Photo](/img/hdr_comparison.png) |
...
<div align="center">
  <img className="doc-image" src="/img/hdr_photo_demo.webp" />
</div>
...
```ts
const format = getCameraFormat(device, [{ photoHdr: true }, { videoHdr: true }])
```
