...
<div className="image-container" style={size}>
  <video xmlns="http://www.w3.org/1999/xhtml" style={{ position: 'absolute', ...size, transform: 'scale(0.88)' }} autoPlay muted loop>
    <source src="/img/demo_drawing.mp4" type="video/mp4" />
  </video>
  <img src="/img/frame.png" style={{ position: 'absolute', ...size }} />
</div>
...
A Skia Frame Processor, just like any other [Frame Processor](/docs/guides/realtime-frame-processing), runs synchronously for every Camera Frame.
