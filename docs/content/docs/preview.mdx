...
<div className="image-container">
  <svg xmlns="http://www.w3.org/2000/svg" width="283" height="535">
    <image href="/img/demo_capture.gif" x="18" y="33" width="247" height="469" />
...
[Skia Frame Processors](/docs/guides/realtime-frame-processing/skia) will disable the native Preview to use a custom Skia Canvas instead.
