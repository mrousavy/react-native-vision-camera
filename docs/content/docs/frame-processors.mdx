...
<div className="image-container">
  <svg xmlns="http://www.w3.org/2000/svg" width="283" height="535">
    <image href="/img/frame-processors.gif" x="18" y="33" width="247" height="469" />
...
Check out [Frame Processor community plugins](/docs/guides/realtime-frame-processing/community-plugins) to discover available community plugins.
...
<Tabs items={['iOS Example (Swift)', 'Android Example (Java)']}>
<Tab value="iOS Example (Swift)">
...
<Tab value="Android Example (Java)">
...
**🚀 See: ["Creating Frame Processor Plugins"](/docs/guides/realtime-frame-processing/plugins) for more information.**
