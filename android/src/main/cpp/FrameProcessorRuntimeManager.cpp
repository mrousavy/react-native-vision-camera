...
void FrameProcessorRuntimeManager::installJSIBindings() {
  ...
  auto setFrameProcessor = [this](jsi::Runtime &runtime,
    ...
    this->setFrameProcessor(runtime, arguments[0], arguments[1]);
  ...
  auto unsetFrameProcessor = [this](jsi::Runtime &runtime,
    ...
    this->unsetFrameProcessor(runtime, arguments[0]);
    return jsi::Value::undefined();
  };
  jsiRuntime.global().setProperty(jsiRuntime,
                                  "unsetFrameProcessor",
...
void FrameProcessorRuntimeManager::setFrameProcessor(jsi::Runtime& runtime,
    ...
    // find camera view
    auto viewTagDouble = viewTag.asNumber();
    auto cameraView = findCameraViewById(static_cast<int>(viewTagDouble));
    ...
    auto worklet = reanimated::ShareableValue::adapt(runtime, frameProcessor,
                                                     _runtimeManager.get());
