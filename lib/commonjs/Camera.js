...
var _CameraViewNativeComponent = _interopRequireDefault(require("./CameraViewNativeComponent"));
...
class Camera extends _react.default.PureComponent {
  ...
  render() {
    ...
    return /*#__PURE__*/_react.default.createElement(_CameraViewNativeComponent.default, _extends({}, props, {
      cameraId: device.id,
      ref: this.ref,
      torch: torch,
      minFps: minFps,
