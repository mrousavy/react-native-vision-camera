...
class Camera extends _react.default.PureComponent {
  ...
  async lockFocusAndExposureToPoint(point) {
    try {
      return await _NativeCameraModule.CameraModule.lockFocusAndExposureToPoint(this.handle, point);
    } catch (e) {
      throw (0, _CameraError.tryParseNativeCameraError)(e);
    }
  }
  async freeFocusAndExposure() {
    try {
      return await _NativeCameraModule.CameraModule.freeFocusAndExposure(this.handle);
    } catch (e) {
      throw (0, _CameraError.tryParseNativeCameraError)(e);
    }
  }
