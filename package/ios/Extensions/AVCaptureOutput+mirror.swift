  ...
  func setOrientation(_ orientation: Orientation) {
    ...
    connections.forEach { connection in
        ...
        if #available(iOS 17.0, *) {
          ...
          // TODO: Don't rotate the video output because it adds overhead. Instead just use EXIF flags for the .mp4 file if recording. Does that work when we flip the camera?
