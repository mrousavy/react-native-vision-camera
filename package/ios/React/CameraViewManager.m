...
RCT_EXPORT_VIEW_PROPERTY(fisheyeW, BOOL);
RCT_EXPORT_VIEW_PROPERTY(fisheyeF, BOOL);
RCT_EXPORT_VIEW_PROPERTY(lensLUTAsset, NSDictionary);
RCT_EXPORT_VIEW_PROPERTY(temperature, NSNumber);
RCT_EXPORT_VIEW_PROPERTY(tint, NSNumber);
